      ...
      if (Platform.OS === 'android') {
        const granted = await PermissionsAndroid.request(
          PermissionsAndroid.PERMISSIONS.ACCESS_FINE_LOCATION,
          {
            ...
            message: 'This app needs access to location to track your position on the map.',
        ...
        // iOS permissions are handled automatically by react-native-geolocation
        setLocationPermission(true);
        getCurrentLocation();
      }
    } catch (error) {
  ...
  const startLocationTracking = () => {
    ...
    const watchId = Geolocation.watchPosition(
      ...
      (error) => {
        ...
        Alert.alert('Tracking Error', 'Failed to track location. Please check your GPS settings.');
      },
      {
        enableHighAccuracy: true,
        timeout: 20000,
